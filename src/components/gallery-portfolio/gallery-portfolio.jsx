    ...
    <div>
      ...
      <div className="flex justify-center p-6 space-x-5 md:space-x-8 lg:space-x-20 lg:mt-4">
        <button id="button1"
          ...
          <img src="./assets/images/LOGO.PNG" className="w-16 hover:w-20 lg:w-28 mx-auto lg:hover:w-32" alt="" />
        </button>
        ...
        <button id="button2"
          ...
          <img
            src="./assets/images/LOGO2.png" className="w-16 hover:w-20 lg:w-28 mx-auto lg:hover:w-32" alt="" />
        </button>
        ...
        <button id="button3"
          ...
          <img src="./assets/images/piercing.jpg" className="w-16 hover:w-20 lg:w-28 mx-auto lg:hover:w-32" alt="" />
        </button>
      </div>
      ...
      {transitions((styles, item) => (
        <animated.div
          className={`content container mx-auto mt-5 p-5 sm:p-8 ${activeContent === item ? 'active' : ''
            }`}
          style={styles}>
