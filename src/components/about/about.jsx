            ...
            <div className="grid gap-10 lg:grid-cols-2">
                <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                    <div className="max-w-xl mb-6">
                        <h2 className="italianno mx-auto max-w-lg mb-6 text-6xl font-medium tracking-tight text-gray-900 sm:text-7xl ">
                            Sobre Mí
                        </h2>
                ...
                <div className="flex items-center justify-center -mx-4 lg:pl-8">
                    <div className="flex flex-col items-end px-3">
                        <img className="object-cover mb-6 rounded shadow-lg h-32 sm:h-52 xl:h-60 w-32 sm:w-52 xl:w-60"
                            src="./public/assets/images/elena.jpg" alt="" />
                        <img className="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40" src="./public/assets/images/elena3.jpg"
                            alt="" />
                    </div>
                    <div className="px-3">
                        <img className="object-cover w-40 h-40 rounded shadow-lg sm:h-64 xl:h-80 sm:w-64 xl:w-80" src="./public/assets/images/elena4.jpg"
                            alt="" />
                    </div>
                </div>
            </div>
